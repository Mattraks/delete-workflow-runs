...
export type RestEndpointMethodTypes = {
    ...
    secretScanning: {
        ...
        getSecurityAnalysisSettingsForEnterprise: {
            parameters: RequestParameters & Omit<Endpoints["GET /enterprises/{enterprise}/code_security_and_analysis"]["parameters"], "baseUrl" | "headers" | "mediaType">;
        ...
        patchSecurityAnalysisSettingsForEnterprise: {
            parameters: RequestParameters & Omit<Endpoints["PATCH /enterprises/{enterprise}/code_security_and_analysis"]["parameters"], "baseUrl" | "headers" | "mediaType">;
        ...
        postSecurityProductEnablementForEnterprise: {
            parameters: RequestParameters & Omit<Endpoints["POST /enterprises/{enterprise}/{security_product}/{enablement}"]["parameters"], "baseUrl" | "headers" | "mediaType">;
